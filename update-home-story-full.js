async function updateStoryFull() {
    ...
    body: [
      {
        component: 'header',
        _uid: 'header-1',
        // Header content from scrape or default
        logo: 'Cold Jet',
        navigation: [
      ...
      },
      {
        ...
        text: 'Advanced Dry Ice Solutions for Industry The Dry Ice Blasting & Production Solutions You Can Trust Experience the power of Cold Jet\'s innovative dry ice technology. We provide high-performance dry ice cleaning machines and dry ice production solutions tailored to your specific business needs.',
      },
      {
        ...
        cards: [
          {
            ...
            image: 'https://www.coldjet.com/wp-content/uploads/plastics.jpg',
  ...
  try {
    console.log('Updating story with full scraped content...');
    ...
    if (response.ok) {
      ...
      console.log('Full update success! Story updated and published.');
      ...
      console.error('Full update error:', response.status, errorData);
    }
  } catch (error) {
